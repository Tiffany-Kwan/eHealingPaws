...
const AdvancedForm = ({ submitting, dispatch }) => {
  ...
  return (
    ...
    >
      <PageHeaderWrapper content="Please fill in your information here">
        <Card title="New appointment" className={styles.card} bordered={false}>
          <Row gutter={16}>
            <Col lg={6} md={12} sm={24}>
              ...
              >
                <Radio.Group name="apptType" defaultValue={0}>
